...
> = ({ children, className, ref, ...props }) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <span className="material-symbols-outlined h-4 w-4 opacity-50 text-[16px] leading-none">
        expand_more
      </span>
...
> = ({ className, ref, ...props }) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <span className="material-symbols-outlined h-4 w-4 text-[16px] leading-none">expand_less</span>
  </SelectPrimitive.ScrollUpButton>
)
...
> = ({ className, ref, ...props }) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <span className="material-symbols-outlined h-4 w-4 text-[16px] leading-none">expand_more</span>
  </SelectPrimitive.ScrollDownButton>
)
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <span className="material-symbols-outlined h-4 w-4 text-[16px] leading-none">check</span>
      </SelectPrimitive.ItemIndicator>
    </span>
