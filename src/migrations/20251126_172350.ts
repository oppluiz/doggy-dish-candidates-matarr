...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_hubs_blocks_slider_aspect_ratio" ADD VALUE 'aspect-[251/150]' BEFORE 'aspect-[116/75]';
  ALTER TYPE "public"."enum__hubs_v_blocks_slider_aspect_ratio" ADD VALUE 'aspect-[251/150]' BEFORE 'aspect-[116/75]';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_hubs_blocks_slider_aspect_ratio" AS ENUM('aspect-[1/1]', 'aspect-[4/5]', 'aspect-[3/4]', 'aspect-[16/9]', 'aspect-[116/75]', 'aspect-[116:75]');
  ...
  CREATE TYPE "public"."enum__hubs_v_blocks_slider_aspect_ratio" AS ENUM('aspect-[1/1]', 'aspect-[4/5]', 'aspect-[3/4]', 'aspect-[16/9]', 'aspect-[116/75]', 'aspect-[116:75]');
