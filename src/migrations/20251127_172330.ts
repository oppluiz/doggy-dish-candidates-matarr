...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" ADD VALUE 'gastroenterology';
  ALTER TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" ADD VALUE 'balance';
  ALTER TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" ADD VALUE 'pest_control';
  ALTER TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" ADD VALUE 'content_cut';
  ALTER TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" ADD VALUE 'vital_signs';
  ALTER TYPE "public"."enum__hubs_v_blocks_icon_slider_boxes_icon" ADD VALUE 'gastroenterology';
  ALTER TYPE "public"."enum__hubs_v_blocks_icon_slider_boxes_icon" ADD VALUE 'balance';
  ALTER TYPE "public"."enum__hubs_v_blocks_icon_slider_boxes_icon" ADD VALUE 'pest_control';
  ALTER TYPE "public"."enum__hubs_v_blocks_icon_slider_boxes_icon" ADD VALUE 'content_cut';
  ALTER TYPE "public"."enum__hubs_v_blocks_icon_slider_boxes_icon" ADD VALUE 'vital_signs';
  ALTER TABLE "hubs_blocks_testimonial" DROP COLUMN "author_title";
  ALTER TABLE "_hubs_v_blocks_testimonial" DROP COLUMN "author_title";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_hubs_blocks_icon_slider_boxes_icon" AS ENUM('restaurant', 'nutrition', 'home', 'egg_alt', 'pet_supplies', 'volunteer_activism', 'health_cross', 'scale', 'shield', 'calendar_today', 'sunny', 'bolt', 'water', 'pill', 'sound_detection_dog_barking', 'pets', 'skillet', 'grain', 'family_home', 'meat_icon', 'favorite', 'neurology', 'mood', 'dentistry', 'rheumatology', 'error', 'health_and_safety');
  ...
  ALTER TABLE "hubs_blocks_testimonial" ADD COLUMN "author_title" varchar;
  ALTER TABLE "_hubs_v_blocks_testimonial" ADD COLUMN "author_title" varchar;`)
}
