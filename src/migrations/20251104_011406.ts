...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "how_to_blocks_how_to_sections_steps" ALTER COLUMN "columns_proportion" SET DEFAULT '7-5';
  ALTER TABLE "_how_to_v_blocks_how_to_sections_steps" ALTER COLUMN "columns_proportion" SET DEFAULT '7-5';`)
}
